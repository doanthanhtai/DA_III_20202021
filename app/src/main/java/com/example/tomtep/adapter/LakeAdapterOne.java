...
public class LakeAdapterOne extends RecyclerView.Adapter<LakeAdapterOne.LakeViewHolder> {
    ...
    public LakeAdapterOne(List<Lake> lakes, List<EnvironmentHistory> environmentHistories, List<OtherUseHistory> otherUseHistories, List<ProductHistory> productHistories, List<Product> products, IClickItemLakeListener iClickItemLakeListener) {
        this.lakes = lakes;
